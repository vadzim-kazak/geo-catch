-- Fishes
-- Pike
INSERT IGNORE INTO domain_property (id, type, item, value, locale, isDefault) VALUES (1, 1, 1, 'pike', 'en', 1);
INSERT IGNORE INTO domain_property (id, type, item, value, locale, isDefault) VALUES (2, 1, 1, 'щука', 'ru', 0);

-- Perch
INSERT IGNORE INTO domain_property (id, type, item, value, locale, isDefault) VALUES (3, 1, 2, 'perch', 'en', 1);
INSERT IGNORE INTO domain_property (id, type, item, value, locale, isDefault) VALUES (4, 1, 2, 'окунь', 'ru', 0);
