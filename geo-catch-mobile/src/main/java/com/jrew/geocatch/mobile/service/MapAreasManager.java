...
public class MapAreasManager {
     ...
     * @param googleMap
     */
    public MapAreasManager(GoogleMap googleMap, Context context) {

        this.googleMap = googleMap;

        imagesFilteringAreasNumber = Double.parseDouble(
                context.getResources().getString(R.config.imagesFilteringAreasNumber));

        imagesFilteringDegreeThreshold = Double.parseDouble(
                context.getResources().getString(R.config.imagesFilteringDegreeThreshold));
    ...
    public void init() {
        ...
        areaSize = minDegreeRange / imagesFilteringAreasNumber;
